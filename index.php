...
<html>
			<body>
				<div>
					...
					<form method="POST">
							<div>
								<center><h2>Welcome To Chip - An all in one tool for destryoing scammers webhooks <a href="https://github.com/eudevelopment">Vuhp</a></h2></center>
							<center>
							<br>
								<table>
								<div class="container">
								  ...
								  <div class="content">
									<h3>Website Developed by [Euphoria]</h3>
									<div class="row">
									<p><textarea class="col-75" type="text" name="message" placeholder="Write something.."></textarea></p>
									</div>
									<br>
									<p>xxx <a href="https://github.com/eudevelopment">CLICK HERE FOR MORE TOOLS</a></p>
